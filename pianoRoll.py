...
class PianoRollApp(tk.Tk): #/ Tk : Toplevel widget of Tk which represents mostly the main window of an application
    def __init__(self,resolution='1600x900',*args,**kwargs): #/ *args : tupla de argumentos posicionales. *kwarg: dict de keyvalue args.
        ...
        for Frame in (StartPage,NewPianoRoll): #/ acá vamos inicializando todas las views y las metemos en el diccionario, para poder mostrarlas luego.
            frame = Frame(container,self) #/ construimos la instancia de cada clase de view, pasamos el contenedor y la instancia de PianoRollApp.
    ...
    def show_frame(self,pageName:str): #/ funcion para mandar el frame del dict adelante.
        frame = self.frames[pageName] #/ usa la clase como key, muestra la instancia de esa clase en la ventana.
